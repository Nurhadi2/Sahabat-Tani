...
<div class="card-body">
                     ...
                     <br>
                    <form action="<?php echo $base_url; ?>/user/data/action_category.php" method="POST" enctype="multipart/form-data">
                     
                        <div class="form-row">
                        <div class="col">   
                        <input type="text" name="nama" class="form-control" placeholder="produk" autofocus required>
                        </div>
                        </div>
                        <br>
                        <div class="form-row">
