...
?>
        <script language ="javascript">location.href ="<?= $base_url ?>/user/index.php"; </script>
<?php
...
?>
        ...
        <script language ="javascript">location.href ="<?= $base_url ?>/login_user/login.php?msg=error"; </script>
